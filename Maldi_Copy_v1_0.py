...
_logext = ".log"
_swname = "MALDI_COPY_"
_status="PRD"  #  <---  Program fejlesztési státus
...
def minimize_list(lista):
    ...
    for elem1 in lista:
        ...
        for elem2 in lista:
            elemb=elem2[:-4]
            if (elema!=elemb) and (elema in elemb) or ("RESULT" in elema.upper()):
                found=True
